...
- [X] STEP 10 — 테스트 알 이미지 표시
- [X] STEP 11 — 알 클릭 및 모바일 터치 영역 구현
- [X] STEP 12 — 친밀도 변수 구현
- [X] STEP 13 — 친밀도 UI 구현
- [X] STEP 14 — 알 터치 시 친밀도 증가
- [X] STEP 15 — 친밀도에 따른 레벨업 구현
- [X] STEP 16 — 알 생성 시간 저장
- [X] STEP 17 — 부화 최소 시간 조건 구현
- [X] STEP 18 — 레벨 + 시간 부화 조건 결합
- [X] STEP 19 — 알 좌우 흔들림 애니메이션
- [X] STEP 20 — 부화 빛 효과 구현
- [X] STEP 21 — 알에서 캐릭터로 교체
